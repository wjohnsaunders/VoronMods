...
lower the steppers so that the couplers are below the mount covers. No Z height is
lost with this approach, and you can't even see the couplers.
...
They lower the stepper by 14mm in addition to the 20mm in the original design. This
gives 34mm in which to hide the coupler, which is ample. The top of the leadscrew
will end up near the same position as if you had steppers with integrated leadscrews.
If you need to cater for longer UHF hotends that could hit the leadscrew, you might
need to cut your leadscrew to size.
...
These should be printed as they appear in the STL file, bottom surface down.
